    ...
    builder
      ...
      .addCase(login.fulfilled, (state, action) => {
        ...
        if (user.subscription) {
          user.subscription = {
            ...user.subscription,
            startDate: user.subscription.startDate instanceof Date 
              ? user.subscription.startDate.toISOString() as any
              : user.subscription.startDate,
            endDate: user.subscription.endDate instanceof Date
        ...
        if (user.voiceSubscription) {
          user.voiceSubscription = {
            ...user.voiceSubscription,
            startDate: user.voiceSubscription.startDate instanceof Date
              ? user.voiceSubscription.startDate.toISOString() as any
              : user.voiceSubscription.startDate,
            endDate: user.voiceSubscription.endDate instanceof Date
