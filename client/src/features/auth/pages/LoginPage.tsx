...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/home/app') // Navigate directly to chat page
    } catch (err: any) {
          ...
          {USE_MOCK_MODE && (
            <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
              ...
              <div className="text-xs text-blue-700 dark:text-blue-300 space-y-1">
                <p>
                  <strong>User:</strong> {MOCK_CREDENTIALS.email} / {MOCK_CREDENTIALS.password}
                </p>
                <p>
                  <strong>Admin:</strong> {MOCK_CREDENTIALS.adminEmail} / {MOCK_CREDENTIALS.adminPassword}
                </p>
              </div>
            </div>
          )}
